package com.mik.ratelmodule.utils;
...
public class HiddenAPIEnforcementPolicyUtils {
    ...
    private static String TAG="HiddenAPIEnforcementPolicyUtils";
    ...
    public static void passApiCheck() {
        ...
        try {
            ...
            Log.w(TAG, "pass Hidden API enforcement policy failed", throwable);
        }
    }
    ...
    public static void reverseApiCheck() {
        ...
        try {
            ...
            Log.w(TAG, "reverseApiCheck failed", throwable);
        }
    }
